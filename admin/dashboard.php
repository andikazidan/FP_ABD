			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">ilung tolol</h2>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Pivot</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">UNPIVOT</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">CASE</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">WHERE</div>
												</div>
											</div>
